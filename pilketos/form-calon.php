           ...
           <div class="card-body">
             ...
             <form action="data-calon.php">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="nama" class="form-control" id="formGroupExampleInput" placeholder="Masukkan Nama Lengkap...">
                </div>
                <!-- kelas -->
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea name="visi" class="form-control" cols="10" rows="5"></textarea>
                </div>
                <div class="col-3">
